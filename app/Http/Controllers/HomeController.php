...
class HomeController extends Controller
{
    ...
    {
        $news      = Blog::where('featured', 1)->get();
        $questions = Question::where('homepage', '=', '1')->get();
        ...
        if (Auth::check()) {  
            ...
            if ($validVote) {
                return view('index')->withQuestions($questions)->withNews($news)->withVoteResults($voteResults);
            }
        }
        return view('index')->withQuestions($questions)->withNews($news);
    }
