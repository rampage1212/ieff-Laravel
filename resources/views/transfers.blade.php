...
@section('metatags')
<!-- Primary Meta Tags -->
<title>IEFF — Transfer Window</title>
<meta name="title" content="IEFF — Transfer Window">
<meta name="description" content="Find a free agent player or admin/referee today!">

<!-- Open Graph / Facebook -->
<meta property="og:type" content="website">
<meta property="og:url" content="{{ Request::url() }}">
<meta property="og:title" content="IEFF — Transfer Window">
<meta property="og:description" content="Find a free agent player or admin/referee today!">
<meta property="og:image" content="https://ie-ff.com/images/ieff_background.jpg">

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="{{ Request::url() }}">
<meta property="twitter:title" content="IEFF — Transfer Window">
<meta property="twitter:description" content="Find a free agent player or admin/referee today!">
...
<section id="page-title" class="page-title-parallax page-title-dark page-title-center" style="background-image: url('images/parallax/8.jpg'); background-size: cover; padding: 120px 0;" data-bottom-top="background-position:0px 0px;" data-top-bottom="background-position:0px -300px;">
	...
	<div class="container clearfix">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">Transfer Window</li>
		</ol>
	</div>
...
<section id="content">
	<div class="content-wrap">
		<div class="container clearfix">
            ...
            <div class="style-msg2 @if($window->status == 1) successmsg @else errormsg @endif">
                <div class="msgtitle">
                    @if($window->status == 1) <i class="icon-line-circle-check"></i> @else <i class="icon-line-circle-cross"></i> @endif
                    The transfer window is currently 
                    @if($window->status == 1) 
                        open 
                        <p style="float:right">Transfer window closes in: <span id="demo"></span></p>
                    @else 
                        closed 
                        <p style="float:right">Transfer window opens in: <span id="demo"></span></p>
                    @endif
                    
                </div>
                <div class="sb-msg">
                    <p class="mb-0">{{ $window->message }}</p>
                </div>
            </div>
            ...
            success: function (data) 
            {
                ...
                else 
                {
                    ...
                    jQuery.each(data.success, function(key, value){
                        /*
                        jQuery('.results').append('<div class="col-6 mt-5"><table class="table table-bordered table-striped"><tbody><tr><td>Type</td><td>'+value['type']+'</td></tr><tr><td>Name</td><td>'+value['name']+'</td></tr><tr><td>Surname</td><td>'+value['surname']+'</td></tr><tr><td>Nickname</td><td>'+value['nickname']+'</td></tr><tr><td>Birth Date</td><td>'+value['birthdate']+'</td></tr><tr><td>Country</td><td>'+value['country']+'</td></tr><tr><td>City</td><td>'+value['city']+'</td></tr><tr><td>Email</td><td>'+value['email']+'</td></tr><tr><td>Consoles</td><td>'+value['consoles']+'</td></tr><tr><td>Games</td><td>'+value['games']+'</td></tr><tr><td>Achievements</td><td>'+value['achievements']+'</td></tr><tr><td>Message User</td><td><a href="/messages/create/'+value['id']+'" class="button button-3d button-rounded button-mini mt-0 mb-0 gradient-ocean"><i class="icon-pencil"></i> Send Message</a></td></tr></tbody></table></div>');
                        */

                        if (value['playstation'] == 1) {
                            value['playstation'] = '<span class="badge badge-success mr-1" style="display: initial;color: #fff;" data-toggle="tooltip" data-placement="top" title="This player competes on Playstation"><i class="icon-line-check"></i> Playstation</span>';
                        } else {
                            value['playstation'] = '<span class="badge badge-danger mr-1" style="display: initial;color: #fff;" data-toggle="tooltip" data-placement="top" title="This player does not compete on Playstation"><i class="icon-line-cross"></i> Playstation</span>';
                        }

                        if (value['xbox'] == 1) {
                            value['xbox'] = '<span class="badge badge-success mr-1" style="display: initial;color: #fff;" data-toggle="tooltip" data-placement="top" title="This player competes on Xbox"><i class="icon-line-check"></i> Xbox</span>';
                        } else {
                            value['xbox'] = '<span class="badge badge-danger mr-1" style="display: initial;color: #fff;" data-toggle="tooltip" data-placement="top" title="This player does not compete on Xbox"><i class="icon-line-cross"></i> Xbox</span>';
                        }

                        if (value['fifa'] == 1) {
                            value['fifa'] = '<span class="badge badge-success mr-1" style="display: initial;color: #fff;" data-toggle="tooltip" data-placement="top" title="This player competes in FIFA esports"><i class="icon-line-check"></i> FIFA</span>';
                        } else {
                            value['fifa'] = '<span class="badge badge-danger mr-1" style="display: initial;color: #fff;" data-toggle="tooltip" data-placement="top" title="This player does not compete in FIFA esports"><i class="icon-line-cross"></i> FIFA</span>';
                        }

                        if (value['pes'] == 1) {
                            value['pes'] = '<span class="badge badge-success" style="display: initial;color: #fff;" data-toggle="tooltip" data-placement="top" title="This player competes in PES esports"><i class="icon-line-check"></i> PES</span>';
                        } else {
                            value['pes'] = '<span class="badge badge-danger" style="display: initial;color: #fff;" data-toggle="tooltip" data-placement="top" title="This player does not compete in PES esports"><i class="icon-line-cross"></i> PES</span>';
                        }

                        if(value['twitch'] != null && value['twitch'] != '') {
                            value['twitch'] = '<a href="'+value['twitch']+'" target="_blank" class="badge badge-info mr-1" style="background-color: #6441a5;display: initial;color: #fff;padding: 0.3em 0.6em;"><i class="icon-twitch"></i></a>';
                        }
                        else {
                            value['twitch'] = '';
                        }
                        ...
                        if(value['twitter'] != null) {
                            value['twitter'] = '<a href="'+value['twitter']+'" target="_blank" class="badge badge-info mr-1" style="background-color: #00acee;display: initial;color: #fff;padding: 0.3em 0.5em;"><i class="icon-twitter"></i></a>';
                        }
                        else {
                            value['twitter'] = '';
                        }
                        ...
                        if(value['youtube'] != null) {
                            value['youtube'] = '<a href="'+value['youtube']+'" target="_blank" class="badge badge-info mr-3" style="background-color: #FF0000;display: initial;color: #fff;padding: 0.3em 0.5em;"><i class="icon-youtube"></i></a>';
                        }
                        else {
                            value['youtube'] = '';
                        }
                        ...
                        if(value['team_name == null']) {
                            value['team_name'] == ['Free Agent'];
                        }

                        if(value['info'] == null) {
                            value['info'] = 'No other information';
                        } 

                        jQuery('.results').append('<div class="col-md-6"><img src="/'+value['avatar']+'" class="alignleft img-circle img-thumbnail" alt="Avatar" style="max-width: 150px; margin: 1rem;"><div class="heading-block" style="background-color:#f6f6f6; border-radius: 1rem; padding: 1rem"><h3><img src="/images/flags/svg/'+value['countrycode'].toLowerCase()+'.svg" class="mr-2" width="24" height="16" data-toggle="tooltip" data-placement="top" title="'+value['city']+' '+value['country']+'" style="margin-top:-5px">'+value['name']+' "'+value['nickname']+'" '+value['surname']+'</h3><h5 style="font-size: 1.1rem;">'+value['twitch']+' '+value['twitter']+' '+value['youtube']+' '+value['playstation']+' '+value['xbox']+' '+value['fifa']+' '+value['pes']+'</h5><span><span style="font-weight:600">Date Of Birth:</span> '+value['birthdate']+'</span><span class="mb-4"><span style="font-weight:600">Current Team:</span> '+value['team_name']+'</span><hr><span><span style="font-weight:600">Achievements:</span> '+value['achievements']+'</span><span><span style="font-weight:600">Other information:</span> '+value['info']+'</span><a href="/messages/create/'+value['id']+'" class="button button-border button-rounded button-green btn-block" style="text-align: center;margin-left: 0px;margin-top: 1rem;"><i class="icon-envelope21"></i> Send Message</a></div></div>');
                    });
...
var countDownDate = new Date("{{ $window->countdown }}").getTime();
