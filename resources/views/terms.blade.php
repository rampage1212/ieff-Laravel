...
@section('metatags')
<!-- Primary Meta Tags -->
<title>IEFF — Terms Of Use</title>
<meta name="title" content="IEFF — Terms Of Use">
<meta name="description" content="IEFF Terms Of Use">

<!-- Open Graph / Facebook -->
<meta property="og:type" content="website">
<meta property="og:url" content="{{ Request::url() }}">
<meta property="og:title" content="IEFF — Terms Of Use">
<meta property="og:description" content="IEFF Terms Of Use">
<meta property="og:image" content="https://ie-ff.com/images/ieff_background.jpg">

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="{{ Request::url() }}">
<meta property="twitter:title" content="IEFF — Terms Of Use">
<meta property="twitter:description" content="IEFF Terms Of Use">
		...
		<div class="container">
			...
			<div class="row col-mb-50">
				<div class="col-12">
					...
					<p>The IEFF website located at https://ie-ff.com is a copyrighted work belonging to IEFF. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
					...
					<p><strong>Cookies and Web Beacons.</strong> Like any other website, IEFF uses ‘cookies’. These cookies are used to store information including visitors’ preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users’ experience by customizing our web page content based on visitors’ browser type and/or other information.</p>
					...
					<p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: Sweden. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
					...
					<p><strong>Your Privacy.</strong> Please read our <a href="/privacy">Privacy Policy.</a></p>
